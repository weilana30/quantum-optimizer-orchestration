...
for chain_len in range(1, 4):
    for chain in product(optimizers.keys(), repeat=chain_len):
        runners.append({
            ...
            "output_dir": f"brute_force_chains/cheap_optimizers/initial_test/optimize_only/reports/chains/{'__'.join(chain)}",
        })
...
config = {
    "metadata": {
        ...
        "default_output_dir": "brute_force_chains/cheap_optimizers/initial_test/optimize_only/reports/",
    },
    "circuits": [
        {
            "name": "qft_8",
